local function Reply(msg)
    ...
    elseif hidConstructor(msg.sender_user_id_, msg.chat_id_) then
    ...
    local TwixTEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
    DevHid2 = math.random(#TwixTEAM) 
    Dev_Hid(msg.chat_id_, msg.id_, 1, TwixTEAM[Devhid2] , 1, 'md') 
    return false
    end
